...
public class MatrixMathematics {
	...
	public static Matrix inverse(Matrix matrix) throws NoSquareException {
		...
		double paramOne = 1.0/determinant;
		Matrix cofactoredMatrix = cofactor(matrix);
		return (transpose(cofactoredMatrix).multiplyByConstant(paramOne));
	}
